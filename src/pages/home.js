...
>>>>>>> 9248c9354a131452d82c96466349cee1bb63f1e1
       ...
       <footer class="bg-[#3E001F] ">
                <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div class="md:flex md:justify-between">
                        <div class="mb-6 md:mb-0">
                            <a href="https://flowbite.com/" class="flex items-center">
                                ...
                                <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">Amberrent</span>
                        ...
                        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            ...
                            <div>
                                ...
                                <ul class="text-white font-medium">
                                    <li class="mb-4">
                                        <a href="https://github.com/caliginosusmoon/" class="hover:underline ">Github</a>
                                    </li>
                                    <li>
                    ...
                    <div class="sm:flex sm:items-center sm:justify-between">
                        <span class="text-sm text-white sm:text-center ">© 2024 <a href="/" class="hover:underline">Amberrent™</a>. All Rights Reserved.
                        </span>
