				...
				<div className="bg-white hover:bg-[#F11A7B] hover:-translate-y-7 duration-300 border rounded-xl flex flex-col items-center shadow-xl w-[480px] h-[600px] py-8">
					...
					<div className="py-10 px-16 pb-10">
						...
						<p className="text-xs font-medium">
							...
							elit. Vivamus tempus ultrices felis, sed aliquam
							dolor dapibus at. Duis fermentum dolor eu faucibus
							commodo. In ut ex et elit pellentesque varius. Etiam
							varius, arcu rhoncus sagittis dictum, nisi ex
							sodales tellus, et ullamcorper eros arcu in lorem.
						</p>
					</div>
				</div>
