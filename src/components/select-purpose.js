	...
	return (
		<div className="w-full">
			<div className="grid grid-cols-2 w-full h-[500px] py-10 gap-4">
				<div
					style={{
						backgroundImage: `linear-gradient(to left, rgba(168,168, 168, 0.22), rgba(25, 25, 25,1)), url(${rectangle13})`,
						backgroundRepeat: "no-repeat",
						backgroundPosition: "center",
						backgroundSize: "cover",
					}}
					className="border rounded-tr-lg rounded-br-xl cursor-pointer"
					onClick={handleChange}
				>
					<div className="py-6 px-8">
						<h2 className="text-[#F11A7B] text-2xl font-bold">
				...
				<div
					style={{
						backgroundImage: `linear-gradient(to left, rgba(168,168, 168, 0.22), rgba(25, 25, 25,1)), url(${rectangle14})`,
						backgroundRepeat: "no-repeat",
						backgroundPosition: "center",
						backgroundSize: "cover",
					}}
					className="border rounded-tl-lg rounded-bl-xl cursor-pointer"
					onClick={handleChange}
				>
					<div className="py-6 px-8">
						<h2 className="text-[#F11A7B] text-2xl font-bold">
