    ...
    return (
        ...
        <div class=" max-w-[1320px] md:py-[80] py-10 flex mx-auto md:flex-row flex-col lg:items-center">
            ...
            <div class="basis-[55%] px-5 ">
                <h1 class=" text-[#F11A7B] text-4xl pb-5 font-bold mob:text-center mob:items-center">About Us</h1>
          ...
          respect.</p>
                ...
                <button class=" my-5 px-2 py-1 bg-[#F11A7B] text-white text-sm lg:px-4 lg:py-2  rounded-lg"><a href='../about.js' class="font-bold">Learn more about us</a></button>
            </div>
